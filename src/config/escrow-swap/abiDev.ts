const abiDev = [
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        indexed: false,
        internalType: "enum EscrowSwapUpgradeable.OrderType",
        name: "orderType",
        type: "uint8",
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_MAX_FILE_FILE_FEE", type: "uint256" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    outputs: [
      ...
      {
        internalType: "enum EscrowSwapUpgradeable.OrderStatus",
        name: "status",
        type: "uint8",
      },
